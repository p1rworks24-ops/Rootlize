"""Completely unused 10-image holdout from v7c, reused for surface-contract v8."""
...
from tools.meaning_eval.db_sot_surface_v8 import configure

# Same unused 10-image set and GT as the v7c comparison holdout.
IMAGES = (
...
if __name__ == "__main__":
    ...
    poc.DEFAULT_OUTPUT = (
        ...
        / "meaning-eval"
        / "runs"
        / "db-source-of-truth-surface-v8-new-holdout10"
    )
