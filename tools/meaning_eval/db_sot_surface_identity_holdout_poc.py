"""Existing holdout10 with identity-bound surface contract; reuse v8 facts."""
...
FACTS_SOURCE = (
    poc.ROOT / "artifacts" / "meaning-eval" / "runs" / "db-source-of-truth-surface-v8-holdout10" / "facts.json"
)
OUTPUT = (
    poc.ROOT / "artifacts" / "meaning-eval" / "runs" / "db-source-of-truth-surface-v8-identity-holdout10"
)
