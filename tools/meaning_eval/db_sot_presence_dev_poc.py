"""Presence-role v7 evaluation on the fixed 24-image development set."""
...
if __name__ == "__main__":
    configure()
    poc.DEFAULT_OUTPUT = poc.ROOT / "artifacts" / "meaning-eval" / "runs" / "db-source-of-truth-presence-v7c-dev24"
