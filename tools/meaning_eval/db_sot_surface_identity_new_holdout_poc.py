"""New holdout10 with identity-bound surface contract; reuse v8 facts."""
...
OUTPUT = (
    poc.ROOT / "artifacts" / "meaning-eval" / "runs" / "db-source-of-truth-surface-v8-identity-new-holdout10"
)
